...
const Projects1 = () => {
  return (
      <section className="p-8" id="projects1">
        <h2 className="my-10 text-center text-3xl lg:text-8xl text-white font-bold">My Certificate</h2>
                ...
                <a href={project.link} key={project.id} target="_blank" className="block" rel="">
                    <div className="relative mb-4  overflow-hidden rounded-lg bg-white shadow-lg">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 m-1 p-1 text-white backdrop-blur-md">
                            ...
                            <p className="max-w-xl text-lg text-black text-center">{project.description}</p>
                        </div>
                    </div>
                </a>
            ))}
